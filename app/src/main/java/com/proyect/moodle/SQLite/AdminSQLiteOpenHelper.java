...
public class AdminSQLiteOpenHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("insert into Usuario (ID_usuario, nombre, edad, sexo, estudios, usuario, password, rol, facultad, fecha_registro) " +
                "values (0, 'Diego Suero',40,'M','Maestria','diego','123',1,'INGENIERIA','18/06/2020')");
        db.execSQL("insert into Usuario (ID_usuario, nombre, edad, sexo, estudios, usuario, password, rol, facultad, fecha_registro) " +
                "values (1, 'Carlos Iriarte',50,'M','Maestria','iriarte','123',2,'INGENIERIA','18/06/2020')");
        db.execSQL("insert into Usuario (ID_usuario, nombre, edad, sexo, estudios, usuario, password, rol, facultad, fecha_registro) " +
                "values (2, 'Patty Pedroza',45,'F','Maestria','patty','123',2,'INGENIERIA','27/10/2020')");
